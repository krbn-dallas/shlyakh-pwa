...
export const en: Dict = {
  ...
  more: {
    ...
    diary: 'Travel diary: quests, notes, photos',
  ...
  diary: {
    title: 'Diary', tab: 'Diary',
    empty: 'Nothing here yet. The first page is waiting.',
    morning: 'Morning', evening: 'Evening', notes: 'Notes',
    plan: 'Plans for today', planPlaceholder: 'What do you want to fit in?',
    tasks: 'Today’s quests', tasksNote: 'Three small things to make the day stick',
    newTasks: 'Different quests',
    questions: 'How was the day?',
    summary: 'Day in a nutshell', summarize: 'Write the summary',
    mood: 'Mood',
    addPhoto: 'Photo', addVideo: 'Video', addAudio: 'Audio', addPlace: 'Place',
    recording: 'Recording…', stop: 'Stop',
    addCaption: 'caption…',
    placeSaved: 'Place saved',
    page: 'Page', of: 'of',
    today: 'Today', future: 'Still ahead', past: 'Past day',
    saved: 'Saved',
    export: 'Build the PDF diary', exporting: 'Building…',
    sync: 'Sync', syncNow: 'Sync now', synced: 'Synced',
    space: 'Diary code', spaceNote: 'Type this code on the second phone to keep the diary together.',
    spaceJoin: 'Join a code', spaceBad: 'That code does not work',
    illustrations: 'Illustrations', illustrationsNote: 'No photos of your own yet — borrow an illustration',
